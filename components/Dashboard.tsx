        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-scale-in">
            <div className="p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-2">จำกัดสิทธิ์เข้าถึง</h3>
              <p className="text-slate-500 mb-6">
                กรุณาเข้าสู่ระบบเพื่อเปิดดูไฟล์เอกสารนี้
              </p>
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 bg-emerald-600 text-white font-semibold rounded-xl hover:bg-emerald-700 shadow-sm transition-colors"
                >
                  เข้าสู่ระบบ
                </button>
              </div>
            ...
            <div className="bg-slate-50 p-3 text-center border-t border-slate-100">
              <p className="text-xs text-slate-400">HealthTrack Security</p>
            </div>
          </div>
        </div>
      )}
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center justify-center gap-1">
                        ...
                        {team.serviceProfileFile && (
                          <a
                            href="#"
                            onClick={(e) => handleFileClick(e, team.serviceProfileFile!)}
